...
SUPABASE_KEY = st.secrets.getimport streamlit as st
import pandas as pd
from datetime import datetime, timedelta
...
<style>
    ...
    .ac-counties { font-size: 0.7rem; color: var(--text-3); margin-top: 0.1rem; }
    ...
    .counties-text { font-size: 0.8rem; line-height: 1.4; max-height: 80px; overflow-y: auto; background: #f1f5f9; padding: 0.5rem; border-radius: 6px; }
        ...
        <div class="info-grid">
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{radius} miles</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Counties</div>
                    <div class="counties-text">{counties}</div>
                </div>
            </div>
...
with f3: 
    ...
    states = sorted(list(set(d.get("state", "") for d in data if d.get("state"))))
    state_filter = st.multiselect("State", states, default=[], key="stf", placeholder="State")
    ...
    with tab:
        ...
        if not subset:
            ...
            for app in subset:
                ...
                counties_preview = app.get("counties", "")
                if counties_preview and len(counties_preview) > 30:
                    counties_preview = counties_preview[:30] + "..."
                ...
                with col1:
                    ...
                    <div class="applicant-card">
                        <div>
                            ...
                            <div class="ac-email">import streamlit as st
import pandas as pd
from datetime import datetime, timedelta
            ...
            for app in subset:
                ...
                with col1:
                    ...
                    <div class="applicant-card">
                        ...
                        <div>
                            ...
                            <div class="ac-counties" title="{app.get('counties', '')}">{counties_preview}</div>
                        </div>
                ...
                with col2:
                    if st.button("View", key=btn_key, use_container_width=True):
                        ...
                        st.rerun(){app.get("email") or ""} {status_badge_html(app.get("status", "NEW"))}</div>
                        </div>
                        <div>
                            <div class="ac-location">{app.get("state", "—")}</div>
                            <div class="ac-radius">{rad}</div>
